...
const posts: Post[] = [
  {
    ...
    content: 'Just achieved a 23% increase in revenue using Livestock Club SA\'s AI breeding recommendations! The Large White x Kolbroek cross is performing exceptionally well. Happy to share my experience with anyone interested.',
  ...
  },
  {
    ...
    content: 'Quick tip for new farmers: Early detection of respiratory issues can save your entire herd. Look for these signs: labored breathing, coughing, and reduced appetite. The AI health scoring in Livestock Club SA has been incredibly helpful for this.',
